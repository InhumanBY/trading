...
class TestRequestTimeout(common.TransactionCase):
    ...
    def setUp(self):
        ...
        self.env["ir.config_parameter"].sudo().set_param(
            "svn_mcp_server.request_timeout", "2"
    ...
    def test_request_timeout_decorator_timeout(self):
        ...
        with (
            ...
            patch(
                "odoo.addons.svn_mcp_server.controllers.rate_limiting.response_utils",
                mock_response_utils,
            ),
        ):
    ...
    def test_request_timeout_disabled_with_zero(self):
        ...
        self.env["ir.config_parameter"].sudo().set_param(
            "svn_mcp_server.request_timeout", "0"
        )
    ...
    def test_request_timeout_disabled_with_negative(self):
        ...
        self.env["ir.config_parameter"].sudo().set_param(
            "svn_mcp_server.request_timeout", "-5"
        )
    ...
    def test_request_timeout_invalid_value(self):
        ...
        self.env["ir.config_parameter"].sudo().set_param(
            "svn_mcp_server.request_timeout", "invalid"
        )
