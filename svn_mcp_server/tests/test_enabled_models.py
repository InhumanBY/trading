...
class TestMcpEnabledModels(TransactionCase):
    ...
    def setUp(self):
        ...
        existing_user_models = self.env["scp.model.access"].search(
        ...
        if existing_model:
            ...
            self.enabled_model = self.env["scp.model.access"].create(
                {
    ...
    def test_model_enabled(self):
        ...
        self.assertTrue(
            self.env["scp.model.access"].is_model_enabled("res.partner"),
    ...
    def test_operation_permissions(self):
        ...
        self.assertTrue(
            self.env["scp.model.access"].check_model_operation_enabled(
                "res.partner", "read"
            ),
    ...
    def test_unique_constraint(self):
        ...
        existing = self.env["scp.model.access"].search(
        ...
        first_record = self.env["scp.model.access"].create(
            {
                "model_id": different_model.id,
                "allow_read": True,
            }
        ...
        with mute_logger("odoo.sql_db"):
            with self.assertRaises(IntegrityError):
                self.env["scp.model.access"].create(
                    {
                        "model_id": different_model.id,
                        "allow_read": True,
                    }
    ...
    def test_ondelete_cascade(self):
        ...
        # Enable it for MCP
        temp_enabled = self.env["scp.model.access"].create(
            {
