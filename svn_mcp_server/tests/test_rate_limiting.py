...
class TestRateLimiting(common.TransactionCase):
    ...
    def setUp(self):
        ...
        self.env["ir.config_parameter"].sudo().set_param(
            "svn_mcp_server.request_limit", "300"
        )
        self.env["ir.config_parameter"].sudo().set_param(
            "svn_mcp_server.enable_rate_limiting", "True"
        )
    ...
    def test_get_request_limit_default(self):
        ...
        with patch(
            "odoo.addons.svn_mcp_server.controllers.rate_limiting.request", mock_request
        ):
    ...
    def test_get_request_limit_custom(self):
        ...
        self.env["ir.config_parameter"].sudo().set_param(
            "svn_mcp_server.request_limit", "100"
        )
    ...
    def test_get_request_limit_unlimited(self):
        ...
        self.env["ir.config_parameter"].sudo().set_param(
            "svn_mcp_server.request_limit", "0"
        )
    ...
    def test_get_request_limit_minimum_enforced(self):
        ...
        self.env["ir.config_parameter"].sudo().set_param(
            "svn_mcp_server.request_limit", "5"
        )
    ...
    @mute_logger("odoo.addons.svn_mcp_server.controllers.rate_limiting")
    def test_get_request_limit_invalid_value(self):
        """Test handling of invalid request limit value"""
        self.env["ir.config_parameter"].sudo().set_param(
            "svn_mcp_server.request_limit", "invalid"
        )
    ...
    def test_check_rate_limit_exceeded(self):
        ...
        self.env["ir.config_parameter"].sudo().set_param(
            "svn_mcp_server.request_limit", "12"
        )
    ...
    def test_rate_limit_decorator_disabled(self):
        ...
        self.env["ir.config_parameter"].sudo().set_param(
            "svn_mcp_server.enable_rate_limiting", "False"
        )
    ...
    def test_rate_limit_decorator_exceeded(self):
        ...
        # Set a limit above minimum (10) for testing
        self.env["ir.config_parameter"].sudo().set_param(
            "svn_mcp_server.request_limit", "11"
        )
        ...
        with patch(
            ...
            with patch(
                "odoo.addons.svn_mcp_server.controllers.response_utils.error_response",
